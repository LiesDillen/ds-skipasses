...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema mealsSchema) {
        ...
        wsdl11Definition.setPortTypeName("Skipassport");
        wsdl11Definition.setLocationUri("/ws");
        wsdl11Definition.setTargetNamespace("http://skipass.io/gt/webservice");
    ...
    public XsdSchema mealsSchema() {
        return new SimpleXsdSchema(new ClassPathResource("skipasses.xsd"));
    }
